            ...
            <div className=' bg-gray-200 h-screen'>
                ...
                <div className=' grid grid-cols-5 sm:grid-cols-1'>
                    <div className='justify-center inline-flex p-12 mt-20 col-start-5'>
                        ...
                        <MagnifyingGlassIcon className=' w-8 text-sm mx-6 hover:text-blue-600 cursor-pointer text-blue-600' />
                    </div>
                    ...
                    <div className=' grid col-start-2 col-span-4 grid-cols-3 gap-6 mr-12'>
                        <Card className=' bg-white rounded-lg p-12 gap-3 grid-cols-1 inline-flex hover:drop-shadow-xl '>
                            ...
                            <div className=' block text-center'>
                                <p className='grid-cols-2 text-center text-xl'>Certificate Portal</p>
                        ...
                        <Card className=' bg-white rounded-md p-12 gap-3 grid-cols-1 inline-flex hover:drop-shadow-xl'>
                            <div className='grid grid-cols-1'>
                                <NewspaperIcon className='w-20 inline text-sky-700' />
                            </div>

                            <div className=' block text-center'>
                                <p className='grid-cols-2 text-center text-xl'>Deferment Portal</p>
                                <p className=' text-2xl font-bold'>100</p>
                            </div>
                        </Card>
                        ...
                        <Card className=' bg-white rounded-md p-12 gap-3 grid-cols-1 inline-flex hover:drop-shadow-xl'>
                            <div className='grid grid-cols-1'>
                                <ClipboardDocumentIcon className='w-20 inline text-sky-700' />
                            </div>
                            <div className=' block text-center'>
                                <p className='grid-cols-2 text-center text-xl'>Transcript Portal</p>
                                <p className=' text-2xl font-bold'>100</p>
                            </div>
