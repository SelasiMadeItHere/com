                    ...
                    <Table className='mt-5'>
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell className=' p-3 inline '>
                                    <Button className='mt-7 grid col-start-1' variant="contained">EDIT</Button>
                                    <Button className='mt-7 col-start-2' style={{ color: "red" }} >DELETE</Button>
                                </TableCell>
                            </TableRow>
