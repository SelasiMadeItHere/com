...
insert  into `tbl_introductory_requests`(`tblid`,`reqid`,`stuid`,`phone`,`for`,`pnumber`,`raddress`,`bname`,`eaddress`,`reciept_path`,`state`,`officer`,`disapprove_reason`,`created_at`,`updated_at`) values (4,'ADS19B00225Y-INTRO-248','ADS19B00225Y','999','For Bank',NULL,'ff','RTT',NULL,NULL,1,1,NULL,'2022-03-01 09:29:49','2022-03-01 09:29:49');
