...
(94,'ADS19B00205Y','Card-627fd2','KCC Campus','Replacement','worked_on','2023-07-06','2023-07-06','0000-00-00','lenovo t440.webp','ads19b00205y@ait.edu.gh'),
...
CREATE TABLE `tbl_introductory_requests` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`tblid`,`reqid`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

/*Data for the table `tbl_introductory_requests` */

insert  into `tbl_introductory_requests`(`tblid`,`reqid`,`stuid`,`phone`,`for`,`pnumber`,`raddress`,`bname`,`eaddress`,`reciept_path`,`status`,`officer`,`disapprove_reason`,`created_at`,`updated_at`) values 
...
insert  into `tbltranscript_requests`(`tblid`,`reqid`,`stuid`,`name`,`prog`,`level`,`phone`,`purpose`,`ogname`,`ogcontact`,`ogemail`,`ogpostal`,`ogphone`,`deliv_mode`,`mode_specify`,`reciept_path`,`status`,`officer`,`disapprove_reason`,`created_at`,`updated_at`) values 
